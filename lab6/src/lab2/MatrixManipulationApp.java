...
public class MatrixManipulationApp {
    ...
    public static void checkMatrixSize(int size) {
        if (size > MAX_MATRIX_SIZE) {
            throw new IllegalArgumentException("Размер матрицы не может превышать " + MAX_MATRIX_SIZE);
        }
    }

    public static int readMatrixSize(String filePath) throws IOException {
    ...
    public String printMatrix(int[][] matrix, String path, String outputText) {
        String result = "";
